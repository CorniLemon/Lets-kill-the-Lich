...
define config.name = _("lets_kill_the_lich!")
...
define gui.about = _p("""
автор - Ната. вероятнее всего вы знаете меня как Corni Lemon\n
это визуальная новелла по мотивам моей нри парти.

'давайте убьем лича!' это история о противоборстве разных интересов и мировозрений, собранная из стереотипных мемов по ДнД. что же вы в итоге решите сделать?

игра находится в разработке и готова примерно на 1/5

огромное спасибо моим игрокам: \n
Ане, Павлу, Насте, Серёже и Мише
...
define build.name = "letskillthelich"
...
define config.save_directory = "letskillthelich-1660136818"
